...
class CoordinateVK {
	...
	func middlePoint(_ other: CoordinateVK) -> CoordinateVK? {
		if lat_direction == other.lat_direction && lon_direction == other.lon_direction {
			return try! CoordinateVK(
	...
	static func middlePoint(_ first: CoordinateVK, _ second: CoordinateVK) -> CoordinateVK? {
...
var coord1 = CoordinateVK()
var coord2 = try! CoordinateVK(-6, -6, 6, 6, 6, 6)
...
var coordmid2 = CoordinateVK.middlePoint(coord2, coord1)
